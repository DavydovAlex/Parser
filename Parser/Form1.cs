...
namespace Parser
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            try
            {
                Uri e = new Uri(@"D:\Prikaz.html");//@"D:\1.txt"   @"https://www.google.com"   @"D:\chm\1234.htm"
                ...
                string table = wrk.RemoveBlock(ref str, HTMLWorker.GetPattern_PAIRED_TAG("table"))[0].Value;
