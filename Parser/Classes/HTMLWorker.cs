...
namespace Parser.Classes
{
    class HTMLWorker
    {
        ...
        /// <returns></returns>
        public static string OpenHtmlFile(string fileName,Encoding encoding)
        {
            string result;
            try
            {
        ...
        public static string GetHtmlFromURL(string URL,Encoding encoding)
        {
            ...
            //request.
            //request.Headers.Add(HttpRequestHeader.UserAgent, "Mozilla / 5.0(Windows NT 10.0; Win64; x64) AppleWebKit / 537.36(KHTML, like Gecko) Chrome / 62.0.3202.94 Safari / 537.36");
            //WebHeaderCollection headers = new WebHeaderCollection();
            //WebHeaderCollection dfvedfv = request.Headers;
            //headers.Add(HttpRequestHeader.UserAgent, "Mozilla");
